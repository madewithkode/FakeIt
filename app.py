...
class MyForm(FlaskForm):
    ...
    level = StringField(validators=[DataRequired()], render_kw={"placeholder": "level"})
...
def invoice():
    ...
    if not form.validate_on_submit():
        ...
        total = "="+str(total)+"="
        return render_template('invoice.html', registration=registration, fullname=fullname, dept=dept, level=level, course1=course1, course2=course2, course3=course3, course4=course4, course5=course5,course6=course6, course7=course7, c1amt=c1amt, c2amt=c2amt, c3amt=c3amt, c4amt=c4amt, c5amt=c5amt, c6amt=c6amt, c7amt=c7amt, passport=passport, total=total)
class Barcode:    
